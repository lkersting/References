...
%%%%% Modified April, 2013       %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% make dose data 139x139x29 for 1mCi
%     -The seed is positioned at (1,1,1) and a quarter of the 70x70x15
%      matrix is calculated. 
% doserate = Sk [U] * ^ [cGy/hr.U] * Aniso * Radial / r^2
...
a= 1;   b= 1;   c= 1; 	    % (a,b,c) the seed position
dx= 0.1; dy= 0.1; dz= 0.5;  % Distance between grid points [cm]

for k= 1:15		% z distance from seed (Δz= k*dz) [cm]
for j= 1:70     % y distance from seed (Δy= j*dy) [cm]
for i= 1:70 	% x distance from seed (Δx= i*dx) [cm]
