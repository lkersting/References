...
%%%%%   Modified April, 2013     %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% make dose data 139x139x29 for 0.4 mCi I-125 seed
%     -The seed is positioned at (1,1,1) and a quarter of the 139x139x29
...
Decay= ln(2)/T;     % I-125 decay constant
...
for k= 1:29		% z distance from seed (z= k*dz) [cm]
for j= 1:139     % y distance from seed (y= j*dy) [cm]
for i= 1:139 	% x distance from seed (x= i*dx) [cm]
